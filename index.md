...
|--------------------|-----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| **Enrollment**     | 1999-2024 | [`fetch_enr()`](https://almartin82.github.io/tnschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/tnschooldata/reference/fetch_enr_multi.md)                             | State, district, campus. Race, gender, FRPL, SpEd, LEP              |
| **Assessments**    | 2019-2025 | [`fetch_assessment()`](https://almartin82.github.io/tnschooldata/reference/fetch_assessment.md) / [`fetch_assessment_multi()`](https://almartin82.github.io/tnschooldata/reference/fetch_assessment_multi.md) | State, district, school. ELA, Math, Science, Social Studies, EOC    |
| Graduation         | —         | —                                                                                                                                                                                                             | Not yet available                                                   |
| **Directory**      | Current   | [`fetch_directory()`](https://almartin82.github.io/tnschooldata/reference/fetch_directory.md)                                                                                                                 | District, school. Principal, superintendent, address, phone, grades |
...
> See
> [DATA-CATEGORY-TAXONOMY.md](https://almartin82.github.io/tnschooldata/DATA-CATEGORY-TAXONOMY.md)
...
- [Full documentation](https://almartin82.github.io/tnschooldata/)
- [Enrollment
  trends](https://almartin82.github.io/tnschooldata/articles/enrollment_hooks.html)
  — 15 stories
- [Assessment
  analysis](https://almartin82.github.io/tnschooldata/articles/assessment_analysis.html)
  — 15 stories
- [Function
  reference](https://almartin82.github.io/tnschooldata/reference/)
